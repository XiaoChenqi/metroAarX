...
import com.facilityone.wireless.maintenance.databinding.ItemElSubHeaderBinding
import com.facilityone.wireless.maintenance.model.MaintenanceEnity


class ELSubTitleProvider : BaseItemProvider<MaintenanceEnity.ElectronicLedgerEntity,BaseViewHolder>() {
    ...
    override fun layout(): Int {
        return R.layout.item_el_sub_header
    }
    ...
    override fun convert(
        ...
        val binding=getBinding<ItemElSubHeaderBinding>(helper.itemView.rootView)!!
