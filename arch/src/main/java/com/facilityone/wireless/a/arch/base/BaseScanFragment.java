...
public abstract class BaseScanFragment <P extends IPresent> extends FMFragment implements IView<P>, ScanInterface{
    private P p;
...
//        refWatcher.watch(this);
    ...
    public void FMScan(Context mcontext, FragmentActivity activity,ScanInterface scanUtil){
        Intent intent = new Intent(mcontext, FzScanActivity.class);
                        ...
                        if (data != null){
                            ...
                            if (result!=null){
                                if (result.originalValue == null){
                                    ...
                                    scanUtil.returnCode(result.originalValue);
                                }
                            }
                        }
