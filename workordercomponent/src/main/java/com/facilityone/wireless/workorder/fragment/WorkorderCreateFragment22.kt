 ...
 */
class WorkorderCreateFragment22 : BaseFragment<WorkorderCreatePresenter?>(), View.OnClickListener,
    ...
    override fun onItemChildClick(adapter: BaseQuickAdapter<*, *>, view: View, position: Int) {
        if (view.id == R.id.iv_photo3) {
            BottomTextListSheetBuilder(context)
                ...
                .setOnSheetItemClickListener(this@WorkorderCreateFragment22)
                .build()
                .show()
...
//                            }
        ...
        if (position == 0) {
            if (mSelectList!!.size < MAX_PHOTO) {
                PictureSelectorManager.camera(
                    this@WorkorderCreateFragment22,
    ...
    override fun onItemClick(adapter: BaseQuickAdapter<*, *>?, view: View, position: Int) {
        PictureSelector.create(this@WorkorderCreateFragment22)
    ...
    companion object {
        ...
        @JvmStatic
        val instance: WorkorderCreateFragment22
            get() {
                val bundle = Bundle()
                bundle.putBoolean(WATER_MARK, true)
                val fragment = WorkorderCreateFragment22()
                fragment.arguments = bundle
                return fragment
            }

        @JvmStatic
        fun getInstance(fromType: Int, equipmentId: Long): WorkorderCreateFragment22 {
            val fragment = WorkorderCreateFragment22()
            val bundle = Bundle()
        ...
        @JvmStatic
        fun getInstance(fromType: Int, equipmentId: String): WorkorderCreateFragment22 {
            val fragment = WorkorderCreateFragment22()
            val bundle = Bundle()
            bundle.putInt(FROM_TYPE, fromType)
