 ...
 *
 */
package com.facilityone.wireless.fm_library.zxing.db;
...
public class LocalAlbumImagePickerHelper {
     ...
     * 相册列表信息
     */
    private HashMap<String, ImageBucket> mImageBucketList = new HashMap<String, ImageBucket>();
    ...
    private void buildImagesBucketList() {
        ...
        mImageBucketRecent.bucketList = new ArrayList<ImageItem>();
